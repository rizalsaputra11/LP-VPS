...
class RewardPlanView(View):
    def __init__(self, user: discord.User):
        ...
        select = Select(
            ...
            options=[
                discord.SelectOption(label="🎁 8 Invites = 16GB RAM 0 stock", value="inv_8_16"),
                discord.SelectOption(label="🏆 15 Invites = 64GB RAM 20 stock", value="inv_15_32"),
                discord.SelectOption(label="🚀 1x Boost = 16GB RAM 0 stock ", value="boost_1_16"),
                discord.SelectOption(label="🚀🚀 2x Boost = 64GB RAM 20 stock", value="boost_2_32"),
            ]
        )
        select.callback = self.select_callback
        self.add_item(select)
